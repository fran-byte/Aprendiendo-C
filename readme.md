...
2. [Identificadores, Tipos de Datos, Variables](#2-identificadores-tipos-de-datos-variables)  
   ...
   - 2.4. [Constantes](#24-constantes)  
3. [Operadores](#3-operadores)  
   - 3.1. [Operadores Aritméticos](#31-operadores-aritméticos)  
   - 3.2. [Operadores Relacionales y Lógicos](#32-operadores-relacionales-y-lógicos)  
   - 3.3. [Operador Asignación](#33-operador-asignación)  
   - 3.4. [Operador sizeof](#34-operador-sizeof)  
   - 3.5. [Operadores sobre Bits](#35-operadores-sobre-bits)  
   - 3.6. [Operador Ternario](#36-operador-ternario)  
4. [Conversión de Tipos de Datos](#4-conversión-de-tipos-de-datos)  
   - 4.1. [Conversión Automática](#41-conversión-automática)  
   - 4.2. [Conversión Forzada](#42-conversión-forzada)  
5. [Sentencias de Control y Bucles](#5-sentencias-de-control-y-bucles)  
   - 5.1. [Sentencia if](#51-sentencia-if)  
   - 5.2. [Sentencia switch](#52-sentencia-switch)  
   - 5.3. [Bucle for](#53-bucle-for)  
   - 5.4. [Bucle while](#54-bucle-while)  
   - 5.5. [Bucle do/while](#55-bucle-dowhile)  
   - 5.6. [Sentencias break y continue](#56-sentencias-break-y-continue)  
6. [Arrays, Cadenas y Punteros](#6-arrays-cadenas-y-punteros)  
   - 6.1. [Arrays y Cadenas](#61-arrays-y-cadenas)  
   - 6.2. [Punteros](#62-punteros)  
7. [Funciones](#7-funciones)  
   - 7.1. [Sentencia return](#71-sentencia-return)  
   - 7.2. [Argumentos de Funciones](#72-argumentos-de-funciones)  
   - 7.3. [Arrays como Argumentos](#73-arrays-como-argumentos)  
   - 7.4. [Argumentos de main()](#74-argumentos-de-main)  
   - 7.5. [Recursividad](#75-recursividad)  
   - 7.6. [Punteros a Funciones](#76-punteros-a-funciones)  
   - 7.7. [static en Funciones](#77-static-en-funciones)  
8. [Estructuras, Campos de Bit, Uniones y Enumeraciones](#8-estructuras-campos-de-bit-uniones-y-enumeraciones)  
   - 8.1. [Estructuras](#81-estructuras)  
   - 8.2. [Campos de Bit](#82-campos-de-bit)  
   - 8.3. [Uniones](#83-uniones)  
   - 8.4. [Enumeraciones](#84-enumeraciones)  
   - 8.5. [typedef](#85-typedef)  
9. [El Preprocesador](#9-el-preprocesador)  
   - 9.1. [Directiva #define](#91-directiva-define)  
   - 9.2. [Directiva #undef](#92-directiva-undef)  
   - 9.3. [Directiva #error](#93-directiva-error)  
   - 9.4. [Directiva #include](#94-directiva-include)  
   - 9.5. [Directivas Condicionales](#95-directivas-condicionales)  
   - 9.6. [Directiva #line](#96-directiva-line)  
   - 9.7. [Directiva #pragma](#97-directiva-pragma)  
10. [Entrada y Salida](#10-entrada-y-salida)  
    - 10.1. [Entrada/Salida desde Consola](#101-entradasalida-desde-consola)  
    - 10.2. [Entrada/Salida desde Fichero](#102-entradasalida-desde-fichero)  
11. [Asignación Dinámica de Memoria](#11-asignación-dinámica-de-memoria)  
    - 11.1. [Reserva Dinámica](#111-reserva-dinámica)  
    - 11.2. [Liberación Dinámica](#112-liberación-dinámica)  
    - 11.3. [Ejemplo Práctico](#113-ejemplo-práctico)  
12. [Apéndices](#12-apéndices)  
    - 12.1. [Funciones de Biblioteca ANSI C](#121-funciones-de-biblioteca-ansi-c)  
    - 12.2. [Ejemplos de Programas](#122-ejemplos-de-programas)  
