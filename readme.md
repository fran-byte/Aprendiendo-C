...
1. [Identificadores, Tipos de Datos, Variables](#11---tipos-de-datos) 
   - 1.1. [Tipos de Datos](#1-1---tipos-de-datos)  
...
2. [Operadores](#3-operadores)  
   ...
   - 2.4. [Operador sizeof](#34-operador-sizeof)  
   - 2.5. [Operadores sobre Bits](#35-operadores-sobre-bits)  
   - 2.6. [Operador Ternario](#36-operador-ternario)  
3. [Conversión de Tipos de Datos](#4-conversión-de-tipos-de-datos)  
   - 3.1. [Conversión Automática](#41-conversión-automática)  
   - 3.2. [Conversión Forzada](#42-conversión-forzada)  
4. [Sentencias de Control y Bucles](#5-sentencias-de-control-y-bucles)  
   - 4.1. [Sentencia if](#51-sentencia-if)  
