...
1. [Identificadores, Tipos de Datos, Variables](#1--identificadores-tipos-de-datos-variables) 
   - 2.1. [Tipos de Datos](#2.1-tipos-de-datos)  
   - 2.2. [Declaración de Variables y Alcance](#2.2-declaración-de-variables-y-alcance)  
   - 2.3. [Especificadores de Almacenamiento](#2.3-especificadores-de-almacenamiento)  
   - 2.4. [Constantes](#2.4-constantes)  
...
3. [Conversión de Tipos de Datos](#4-conversión-de-tipos-de-datos)  
   - 4.1. [Conversión Automática](#41-conversión-automática)  
   - 4.2. [Conversión Forzada](#42-conversión-forzada)  
4. [Sentencias de Control y Bucles](#5-sentencias-de-control-y-bucles)  
